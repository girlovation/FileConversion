...
public class FileConversionConstants {
	...
	public static final String CLASS_FOLDER_PATH = FileSystems.getDefault()
			.getPath(System.getProperty("user.home")).toString();

	public static final String JSON_INPUT_VO = "DynamicJsonInVO";

	public static final String JSON_INPUT_VO_PATH = FileSystems.getDefault()
			.getPath(System.getProperty("user.home"), "DynamicJsonInVO.java")
			.toString();
	public static final String JSON_INPUT_LINE_MAPPER_PATH = FileSystems
			.getDefault()
			.getPath(System.getProperty("user.home"),
					"JsonToCsvLineMapper.java").toString();
	...
	/*
	 * public static final String JSON_LINE_MAPPER_PATH =
	 * FileConversionConstants.class
	 * .getClassLoader().getResource("JsonToCsvLineMapper.java").getPath()
	 * .toString();
	 */
}
